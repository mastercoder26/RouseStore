...
export const SEED_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    originalPrice: 110,
    tag: "Footwear",
    description: "Low-profile court sneakers with leather uppers, cushioned insole, and gold heel accents.",
  ...
  },
  {
    ...
    price: 14,
    tag: "College-ruled",
    description: "Hardcover journal with 160 college-ruled pages, ribbon marker, and gold foil Rouse emblem.",
  ...
  },
  {
    ...
    price: 48,
    tag: "Accessories",
    description: "50x60 inch maroon sherpa fleece blanket with gold braided edge trim.",
  ...
  },
  {
    ...
    price: 9,
    tag: "Black ink",
    description: "Pack of three 0.5mm black gel pens with matte comfort grip barrels.",
  ...
  },
  {
    ...
    price: 4.5,
    tag: "12 oz Chilled",
    description: "12 oz canned nitro cold brew coffee.",
  ...
  },
  {
    ...
    price: 3.5,
    tag: "Snack",
    description: "Dark chocolate bar with whole almonds and 12g protein.",
